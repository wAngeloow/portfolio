...
function abrirModal(projetoId) {
    const projetos = [
        ...
        {
            title: { pt: 'BARBEARIA' },
            description: { pt: 'Este projeto simula o site de uma barbearia fictícia, focando em um design responsivo e dinâmico. Ele oferece funcionalidades como navegação rápida, agendamento de horários, exibição de serviços, equipe e localização interativa. O site também inclui links para redes sociais e facilita a interação com os usuários.' + '\n\n' + 'HTML, CSS, Bootstrap, JavaScript' },
            image: 'img/barbearia.png',
            deploy: 'https://wangeloow.github.io/barber/',
            github: 'https://github.com/wAngeloow/barber',
            figma: 'https://www.figma.com/design/EZcTjcuZzG8A91zlI2lMSw/Barber?node-id=0-1&t=daoNnxvX7RAGxNkV-1'
        },
    ];
